    ...
    <main>
        <div class="mt-24 flex flex-col justify-center items-center text-white">
            <!-- Content here -->
            <a href="" class="text-4xl text-center font-bold">Temukan Artikel Yang Menarik Disini!</a>
            <h3 class="w-2/3 mt-5 text-tua text-center">
                Jelajahi berbagai artikel menarik yang ditulis oleh <span class="text-muda">penulis berbakat</span> dari berbagai latar belakang. Dari tips <span class="text-muda">gaya hidup</span>, teknologi terbaru hingga <span class="text-muda">cerita perjalanan</span> yang memukau, temukan konten yang menginspirasi dan <span class="text-muda">memperkaya</span> wawasan Anda setiap hari.
            </h3>
        </div>
        <div class="flex flex-col justify-center items-center text-white">
            <a href="#" class="text-4xl mt-10 text-center font-bold">Mulailah Perjalanan Membaca Anda Hari Ini!</a>
            <h3 class="w-2/3 mt-5 text-tua text-center">
                Tidak ada waktu yang lebih baik dari <span class="text-muda">sekarang</span> untuk mulai menjelajahi cerita-cerita yang menarik. <span class="text-muda">Daftarlah</span> hari ini dan <span class="text-muda">temukan</span> <span class="text-muda">perjalanan</span> membaca yang menakjubkan bersama kami. Kami tidak sabar untuk berbagi <span class="text-muda">cerita menarik</span> dengan Anda dan melihat dunia melalui <span class="text-muda">perspektif</span> yang baru.
            </h3>
        </div>
